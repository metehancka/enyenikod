...
class Bag:
    ...
    def __init__(self):
        ...
        while True:
            ...
            #bu break aktifolursa birinci vidyoyu okumadan atlar eger bu islem daha once yapilmissa bu islemi
            #break
        ...
        input_movie = cv2.VideoCapture(path+"secondVideo.mp4")
        length = int(input_movie.get(cv2.CAP_PROP_FRAME_COUNT))
